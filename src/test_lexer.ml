...
let () =
  (*   0123456789 *)
  test "3.4"      [FLOAT 3.4, 1, 0, 3];
  test " 3.4"     [FLOAT 3.4, 1, 0, 4];
  test "\n3.4"    [FLOAT 3.4, 2, 1, 4];
  test "3.4 .5"   [FLOAT 3.4, 1, 0, 3; FLOAT 0.5, 1, 0, 6];
  test "3.4\n .5" [FLOAT 3.4, 1, 0, 3; FLOAT 0.5, 2, 4, 7];
  (*   0123456789 *)
  test "3 .4"     [INTEGER 3, 1, 0, 1; FLOAT 0.4, 1, 0, 4];
  test "3..4"     [INTEGER 3, 1, 0, 1; FULLSTOP, 1, 0, 2; FLOAT 0.4, 1, 0, 4];
  test "3."       [INTEGER 3, 1, 0, 1; FULLSTOP, 1, 0, 2];
  test "-3."      [INTEGER (-3), 1, 0, 2; FULLSTOP, 1, 0, 3];
  (*   0123456789 *)
  test "3%...\n3"       [INTEGER 3, 1, 0, 1; INTEGER 3, 2, 6, 7];
  test "3/*..*/3"       [INTEGER 3, 1, 0, 1; INTEGER 3, 1, 0, 8];
  test "3/*\n.*/3"      [INTEGER 3, 1, 0, 1; INTEGER 3, 2, 4, 8];
  test "3/*\n/*\n*/*/3" [INTEGER 3, 1, 0, 1; INTEGER 3, 3, 7, 12];
  (*   0123456789012345 *)
